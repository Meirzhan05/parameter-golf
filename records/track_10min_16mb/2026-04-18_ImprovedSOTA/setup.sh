#!/bin/bash
# ---------------------------------------------------------------
# Setup script for Improved SOTA submission
# Run from the repo root: bash records/track_10min_16mb/2026-04-18_ImprovedSOTA/setup.sh
# ---------------------------------------------------------------
set -e
...
echo "============================================"
echo " Improved SOTA — Environment Setup"
echo "============================================"
...
# ---------------------------------------------------------------
# 3. Dataset + Tokenizer (sp8192)
# ---------------------------------------------------------------
echo ""
echo "[3/3] Downloading dataset (sp8192)..."
...
train = sorted(glob.glob("./data/datasets/fineweb10B_sp8192/fineweb_train_*.bin"))
val   = sorted(glob.glob("./data/datasets/fineweb10B_sp8192/fineweb_val_*.bin"))
...
echo ""
echo "   torchrun --nproc_per_node=8 records/track_10min_16mb/2026-04-18_ImprovedSOTA/train_gpt.py"
echo ""
echo " Or with hyperparameter experiments:"
echo "   QK_GAIN_INIT=5.5 MUON_WD=0.10 torchrun --nproc_per_node=8 records/track_10min_16mb/2026-04-18_ImprovedSOTA/train_gpt.py"
echo ""
echo "============================================"
